...
#' see \link[HDF5DatqFrame]{HDF5ColumnVector}
...
#' 
#' The HDF5ColumnSeed class for \link[HDF5DatqFrame]{HDF5ColumnVector}.
#'
#' @param path The path (as a single string or H5File object) to the HDF5 file 
#' (.h5 or .h5ad) where the dataset is located. 
...
#' \link[HDF5DataFrame]{HDF5DataFrame} class
#'
#' @param seed An \link[HDF5DatqFrame]{HDF5ColumnSeed} object
#'
